    ...
    return(
        <div className='row portfolioBackground d-flex justify-content-evenly' style={{ backgroundImage: "url(/img/coding.jpg)" }}>
            <article className="project1" className="border col-3 p-3 m-3">
                ...
                <a href={projects[0].repoLink} target="_blank" className='githubLink'><br/><AiFillGithub /></a>
            ...
            <article className="project2" className="border col-3 p-3 m-3">
                ...
                <a href={projects[1].repoLink} target="_blank" className='githubLink'><br/><AiFillGithub /></a>
                <div class="mt-2 border"></div>
            ...
            <article className="project3" className="border col-3 p-3 m-3">
                ...
                <a href={projects[2].repoLink} target="_blank" className='githubLink'><br/><AiFillGithub /></a>
                <div class="mt-2 border"></div>
            ...
            <article className="project4" className="border col-3 p-3 m-3">
                ...
                <a href={projects[3].repoLink} target="_blank" className='githubLink'><br/><AiFillGithub /></a>
                <div class="mt-2 border"></div>
            ...
            <article className="project5" className="border col-3 p-3 m-3">
                ...
                <a href={projects[4].repoLink} target="_blank" className='githubLink'><br/><AiFillGithub /></a>
                <div class="mt-2 border"></div>
            ...
            <article className="project6" className="border col-3 p-3 m-3">
                ...
                <a href={projects[5].repoLink} target="_blank" className='githubLink'><br/><AiFillGithub /></a>
                <div class="mt-2 border"></div>
